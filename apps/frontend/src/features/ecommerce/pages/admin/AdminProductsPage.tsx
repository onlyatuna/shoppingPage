...
export default function AdminProductsPage() {
    ...
    const updateProductMutation = useMutation({
        ...
        onError: (err: { response?: { data?: { message?: string } } }) => alert(err.response?.data?.message || '更新失敗')
    });
    ...
    const deleteProductMutation = useMutation({
        ...
        onError: (err: { response?: { data?: { message?: string } } }) => alert(err.response?.data?.message || '刪除失敗')
    });
